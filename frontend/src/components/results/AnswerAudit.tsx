    ...
    <div>
      ...
      <div className="rounded border border-border overflow-hidden bg-background">
        <div className="hidden md:grid grid-cols-[auto_1fr_1fr] gap-4 p-4 border-b border-border bg-secondary/30">
          <div className="text-xs font-semibold uppercase tracking-widest text-muted w-8 text-center">
            #
          </div>
        ...
        <div className="divide-y divide-border">
          {questions.map((q, i) => {
            ...
            return (
              <div
                key={q.id}
                className="group p-4 md:p-0 md:grid grid-cols-[auto_1fr_1fr] gap-4 items-stretch hover:bg-secondary/20 transition-colors"
              >
                ...
                <div className="py-2 md:py-4 md:pr-4 flex flex-col justify-center mb-3 md:mb-0">
                  <span className="md:hidden text-[10px] uppercase tracking-widest text-muted font-semibold mb-1">
                    Question {i + 1}
                  </span>
